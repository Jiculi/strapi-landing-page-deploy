...
export interface ApiLandingPageLandingPage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bloks: Attribute.DynamicZone<
      ['bloks.hero', 'bloks.row', 'bloks.pricing', 'bloks.cta']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    informacionProducto: Attribute.Text;
    informacionCompra: Attribute.Text;
    descripcion: Attribute.String;
    imagenProducto: Attribute.Media;
